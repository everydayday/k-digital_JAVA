...
class Tree5 {
	...
	void inorder() {	// driver 함수	// workhorse
		inorder(root);
	}
	...
	void postorder() {	// root부터 해서 자기자신을 계속 돌려.. 자기 자신에 접근 가능해짐
		postorder(root);
	}
	...
	boolean delete(int num) {//binary search tree에서 임의 값을 갖는 노드를 찾아 삭제한다.	// 난도 높음
